...
""" 
CC Checker & Generator for ZThon™ t.me/xsara_v
Write file by Zelzal t.me/xsara_v
hhh o ya beby
...
async def song2(event):
    ...
    chat = "@SDBB_Bot" # code by t.me/xsara_v
...
async def song2(event): # code by t.me/xsara_v
...
async def song2(event):
    been = "410039xxxxxxxxxx|xx|xxxx|xxx" # code by t.me/xsara_v
    chat = "@SDBB_Bot" # code by t.me/xsara_v
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "524447000053xxxx|xx|xxxx|xxx" # code by t.me/xsara_v
    chat = "@SDBB_Bot" # code by t.me/xsara_v
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "373352589xxxxxx|xx|xxxx|xxxx" # code by t.me/xsara_v
    chat = "@SDBB_Bot" # code by t.me/xsara_v
    reply_id_ = await reply_id(event)
