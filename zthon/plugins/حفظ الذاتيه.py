...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝑆𝐴𝑅𝐴 - حفـظ الذاتيـه 🧧](t.me/xsara_v) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
...
async def oho(event):
    ...
    xsara_v = await event.get_reply_message()
    pic = await xsara_v.download_media()
