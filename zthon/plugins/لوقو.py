...
""" 
Logo & Style for ZThon™ t.me/xsara_v
...
async def lg1(userevent):
    ...
    if gvarstatus("ZED_FONTS") is None: # code by t.me/xsara_v
    ...
    if arabic_text: # code by t.me/xsara_v
...
async def lg1(userevent):
    ...
    if not arabic_text: # code by t.me/xsara_v
