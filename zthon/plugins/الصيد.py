...
ZelzalChecler_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝑆𝐴𝑅𝐴 - اوامـر الصيـد والتشيكـر](t.me/xsara_v) 𓆪\n\n"
    ...
    try:
        ch = await zedub(
            functions.channels.CreateChannelRequest(
                title="⎉ صيـد زدثـــون 𝑆𝐴𝑅𝐴 ⎉",
                about="This channel to hunt username by - @xsara_v ",
            )
        )
