...
async def _(event):
    ...
    sandy = await edit_or_reply(
        ...
        f"**•⎆┊يتـم الان اعـادة تشغيـل بـوت ساره قـد يستغـرق الامـر 1-2 دقيقـه ▬▭ ...**",
    )
    try:
